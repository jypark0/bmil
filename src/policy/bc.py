...
class BMILPolicy(ImitationPolicy):
    def __init__(
        self,
    ...
    def update(
        ...
        **kwargs: Any,
        ...
        # Demo buffer
        demo_sample_size = sample_size
        if model_buffer is not None:
            demo_sample_size = int(self.demo_ratio * sample_size)
        ...
        model_sample_size = sample_size - demo_sample_size
        ...
        # Combine batches
        batch = Batch.cat([demo_batch, model_batch])
        ...
        if demo_buffer is not None:
            if model_buffer is not None:
                demo_sample_size = int(
                    min(self.bc_ratio * sample_size, sample_size - env_sample_size)
                )
            else:
